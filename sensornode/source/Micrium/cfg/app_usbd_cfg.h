...
#define  APP_CFG_USBD_AUDIO_RECORD_NBR_BUF                 20u  /* Nbr of record buf.                                   */
#define  APP_CFG_USBD_AUDIO_RECORD_CORR_PERIOD             16u  /* Record correction period in ms.                      */
#define  APP_CFG_USBD_AUDIO_RECORD_CORR_UNDERRUN            2u  /* Record buf queue lower limit to apply correction.    */
#define  APP_CFG_USBD_AUDIO_RECORD_CORR_OVERRUN             2u  /* Record buf queue upper limit to apply correction.    */


#if (APP_CFG_USBD_AUDIO_SIMULATION_LOOP_EN == DEF_ENABLED)
#define  APP_CFG_USBD_AUDIO_PLAYBACK_NBR_BUF               20u  /* Nbr of playback buf.                                 */
#define  APP_CFG_USBD_AUDIO_PLAYBACK_PRE_BUF                5u  /* Nbr of buf to accumulate to prime playback stream.   */
#define  APP_CFG_USBD_AUDIO_PLAYBACK_CORR_PERIOD           16u  /* Playback correction period in ms.                    */
#define  APP_CFG_USBD_AUDIO_PLAYBACK_CORR_UNDERRUN          2u  /* Playback buf queue lower limit to apply correction.  */
#define  APP_CFG_USBD_AUDIO_PLAYBACK_CORR_OVERRUN           2u  /* Playback buf queue upper limit to apply correction.  */
...
#define  USBD_RAMDISK_CFG_BLK_SIZE                       1024u
#define  USBD_RAMDISK_CFG_NBR_BLKS                         23u
