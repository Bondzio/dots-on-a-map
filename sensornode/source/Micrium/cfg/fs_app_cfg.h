...
#ifndef  __FS_APP_CFG_H__
#define  __FS_APP_CFG_H__
...
#define  APP_CFG_FS_MAX_SEC_SIZE     1024                       /* Maximum sector size supported.                       */
...
#define  APP_CFG_FS_RAM_NBR_SECS       8                        /* RAMDisk size in sectors.                             */
#define  APP_CFG_FS_RAM_SEC_SIZE    1024                        /* RAMDisk sector size in byte.                         */
...
#define  APP_CFG_FS_DATAFLASH_NBR_SECS      16                  /* DataFlash size in sectors.                           */
#define  APP_CFG_FS_DATAFLASH_SEC_SIZE     512                  /* DataFlash sector size in byte.                       */
#define  APP_CFG_DATAFLASH_BASE_ADDR         0x00100000
