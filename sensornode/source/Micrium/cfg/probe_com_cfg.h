...
#define  PROBE_TCPIP_CFG_SOCK_BLOCK_EN DEF_DISABLED             /* Configure blocking or non-blocking socket mode.      */
#define  PROBE_TCPIP_CFG_SOCK_WAIT_DLY                    10    /* Task delay used when in non-blocking socket mode.    */
/*
*********************************************************************************************************
