...
USBD_DRV_EP_INFO  const  USBD_DrvEP_InfoTbl_RX111[] = {
...
USBD_DRV_BSP_API  USBD_DrvBSP_YWirelessRX111 = {
    USBD_BSP_Init,                                              /* Init board-specific USB controller dependencies.     */
    USBD_BSP_Conn,                                              /* Enable  USB controller connection dependencies.      */
    USBD_BSP_Disconn                                            /* Disable USB controller connection dependencies.      */
};
...
static  void  USBD_BSP_Init (USBD_DRV  *p_drv)
{
    ...
    IEN(USB0, USBI0)   = 1;
    IEN(USB0, USBR0)   = 1;
                                                                /* Put USB0_VBUS pin in 'input' mode                    */
    PORTC.PDR.BIT.B4 = 1;
                                                                /* Bring USB out of standby                             */
