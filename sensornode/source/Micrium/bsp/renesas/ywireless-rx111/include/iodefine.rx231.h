...
/* History    : V0.5A (2014-09-18)  [Hardware Manual Revision : 0.50]           */
...
struct st_port3 {
	...
	union {
		...
		struct {
			unsigned char B7:1;
			unsigned char B6:1;
			unsigned char B5:1;  // TODO: why was this missing?
			unsigned char B4:1;
			unsigned char B3:1;
			unsigned char B2:1;
			unsigned char B1:1;
...
struct st_s12ad {
	...
	union {
		...
		struct {
			unsigned short :8;
			unsigned short ANS007:1;
			unsigned short ANS006:1;
			unsigned short ANS005:1;
			unsigned short ANS004:1;
			unsigned short ANS003:1;
			unsigned short ANS002:1;
			unsigned short ANS001:1;
			unsigned short ANS000:1;
		} BIT;
	} ADADS0;
	union {
		unsigned short WORD;
		struct {
			unsigned short ANS115:1;
			unsigned short ANS114:1;
			unsigned short ANS113:1;
			unsigned short ANS112:1;
			unsigned short ANS111:1;
			unsigned short ANS110:1;
			unsigned short ANS109:1;
			unsigned short ANS108:1;
			unsigned short ANS107:1;
			unsigned short ANS106:1;
			unsigned short ANS105:1;
			unsigned short ANS104:1;
			unsigned short ANS103:1;
			unsigned short ANS102:1;
			unsigned short ANS101:1;
			unsigned short ANS100:1;
		} BIT;
	} ADADS1;
	union {
		unsigned char BYTE;
	...
	union {
		...
		struct {
			...
			unsigned char CMPBIE:1;
			unsigned char :1;
			unsigned char CMPAE:1;
			unsigned char :1;
			unsigned char CMPBE:1;
			unsigned char :1;
		} BIT;
	} ADCMPCR;
	char           wk11[1];
...
IR_ICU_SWINT=27,
IR_CMT0_CMI0,IR_CMT0_CMI1,
IR_CMT1_CMI2,IR_CMT1_CMI3,
...
IR_CAN_COMFRXINT=52,IR_CAN_RXFINT,IR_CAN_TXINT,IR_CAN_CHERRINT,IR_CAN_GLERRINT,
IR_DOC_DOPCF,
...
enum enum_dtce {
DTCE_ICU_SWINT=27,
DTCE_CMT0_CMI0,DTCE_CMT0_CMI1,
DTCE_CMT1_CMI2,DTCE_CMT1_CMI3,
DTCE_USB0_D0FIFO0=36,DTCE_USB0_D1FIFO0,
DTCE_SDHI_SBFAI=40,
DTCE_RSPI0_SPRI0=45,DTCE_RSPI0_SPTI0,
DTCE_CAN_COMFRXINT=52,
...
IER_FCU_FRDYI=0x02,
IER_ICU_SWINT=0x03,
IER_CMT0_CMI0=0x03,IER_CMT0_CMI1=0x03,
IER_CMT1_CMI2=0x03,IER_CMT1_CMI3=0x03,
...
IER_CAN_COMFRXINT=0x06,IER_CAN_RXFINT=0x06,IER_CAN_TXINT=0x06,IER_CAN_CHERRINT=0x06,IER_CAN_GLERRINT=0x07,
IER_DOC_DOPCF=0x07,
...
IPR_FCU_FRDYI=2,
IPR_ICU_SWINT=3,
IPR_CMT0_CMI0=4,IPR_CMT0_CMI1=5,
IPR_CMT1_CMI2=6,IPR_CMT1_CMI3=7,
...
IPR_CAN_COMFRXINT=52,IPR_CAN_RXFINT=53,IPR_CAN_TXINT=54,IPR_CAN_CHERRINT=55,IPR_CAN_GLERRINT=56,
IPR_DOC_DOPCF=57,
...
#define	IEN_CMT0_CMI1		IEN5
#define	IEN_CMT1_CMI2		IEN6
#define	IEN_CMT1_CMI3		IEN7
...
#define	IEN_CAN_COMFRXINT	IEN4
#define	IEN_CAN_RXFINT		IEN5
#define	IEN_CAN_TXINT		IEN6
#define	IEN_CAN_CHERRINT	IEN7
#define	IEN_CAN_GLERRINT	IEN0
...
#define	VECT_CMT0_CMI1		29
#define	VECT_CMT1_CMI2		30
#define	VECT_CMT1_CMI3		31
...
#define	VECT_CAN_COMFRXINT	52
#define	VECT_CAN_RXFINT		53
#define	VECT_CAN_TXINT		54
#define	VECT_CAN_CHERRINT	55
#define	VECT_CAN_GLERRINT	56
...
#define	MSTP_CAN	SYSTEM.MSTPCRB.BIT.MSTPB0
...
#define	CAN		(*(volatile struct st_can        __sfr __evenaccess *)0xA8322)
#define	CAN0	(*(volatile struct st_can0       __sfr __evenaccess *)0xA8300)
...
#define	SMCI11	(*(volatile struct st_smci0      __sfr __evenaccess *)0x8A150)
...
#define	TEMPSCONST		(*(volatile struct st_tempsconst __sfr __evenaccess *)0x7FC0A0)
