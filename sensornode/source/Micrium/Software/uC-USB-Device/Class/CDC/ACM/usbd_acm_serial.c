...
* Return(s)   : none.
*
* Caller(s)   : USBD_CDC_CommIF_Desc() via 'p_drv->FnctDesc()'.
*
...
* Return(s)   : none.
*
* Caller(s)   : USBD_CDC_CommIF_DescSizeGet() via 'p_drv->FnctDescSizeGet()'.
*
* Note(s)     : none.
*********************************************************************************************************
*/
