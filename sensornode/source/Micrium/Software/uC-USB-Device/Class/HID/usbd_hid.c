...
* Return(s)   : none.
*
* Caller(s)   : USBD_CfgOpen() via 'p_class_drv->Conn()'.
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
* Return(s)   : none.
*
* Caller(s)   : USBD_CfgClose() via 'p_class_drv->Disconn()'.
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
* Return(s)   : none.
*
* Caller(s)   : USBD_StdReqIF() via 'p_class_drv->UpdateAltSetting()'.
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
* Return(s)   : none.
*
* Caller(s)   : USBD_StdReqEP() via 'p_class_drv->EP_StateUpdate()'.
*
...
* Return(s)   : none.
*
* Caller(s)   : USBD_CfgDescSend() via 'p_class_drv->IF_Desc()'.
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
*
* Caller(s)   : USBD_CfgDescSend() via 'p_class_drv->IF_DescSizeGet()'.
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
*               DEF_FAIL, otherwise.
*
* Caller(s)   : USBD_StdReqIF() via 'p_class_drv->IF_Req()'.
*
...
*               DEF_FAIL, otherwise.
*
* Caller(s)   : USBD_StdReqClass() via 'p_class_drv->ClassReq()'.
*
...
* Return(s)   : none.
*
* Caller(s)   : USBD_HID_ClassReq() via 'p_comm->IntrRdAsyncFnct()'.
*
* Note(s)     : none.
*********************************************************************************************************
*/
