...
*
* File           : usbd_audio_drv_template.c
* Version        : V4.05.00.00
* Programmer(s)  : CM
*                  JFD
*********************************************************************************************************
...
static  CPU_INT08U   USBD_Audio_OT_CopyProtTbl[APP_CFG_USBD_AUDIO_NBR_ENTITY];

static  CPU_BOOLEAN  USBD_Audio_FU_MuteTbl[APP_CFG_USBD_AUDIO_NBR_ENTITY][USBD_AUDIO_MAX_LOG_CH];

static  CPU_INT16U   USBD_Audio_FU_VolTbl[APP_CFG_USBD_AUDIO_NBR_ENTITY][USBD_AUDIO_MAX_LOG_CH];

static  CPU_INT08U   USBD_Audio_FU_BassTbl[APP_CFG_USBD_AUDIO_NBR_ENTITY][USBD_AUDIO_MAX_LOG_CH];

static  CPU_INT08U   USBD_Audio_FU_MidTbl[APP_CFG_USBD_AUDIO_NBR_ENTITY][USBD_AUDIO_MAX_LOG_CH];

static  CPU_INT08U   USBD_Audio_FU_TrebleTbl[APP_CFG_USBD_AUDIO_NBR_ENTITY][USBD_AUDIO_MAX_LOG_CH];

static  CPU_INT08U   USBD_Audio_FU_GraphicEqualizerTbl[APP_CFG_USBD_AUDIO_NBR_ENTITY][USBD_AUDIO_MAX_LOG_CH][USBD_AUDIO_FU_GRAPHIC_EQUALIZER_MAX_BANDS];

static  CPU_BOOLEAN  USBD_Audio_FU_AutoGainTbl[APP_CFG_USBD_AUDIO_NBR_ENTITY][USBD_AUDIO_MAX_LOG_CH];

static  CPU_INT16U   USBD_Audio_FU_DlyTbl[APP_CFG_USBD_AUDIO_NBR_ENTITY][USBD_AUDIO_MAX_LOG_CH];

static  CPU_BOOLEAN  USBD_Audio_FU_BassBoostTbl[APP_CFG_USBD_AUDIO_NBR_ENTITY][USBD_AUDIO_MAX_LOG_CH];

static  CPU_BOOLEAN  USBD_Audio_FU_LoudnessTbl[APP_CFG_USBD_AUDIO_NBR_ENTITY][USBD_AUDIO_MAX_LOG_CH];

static  CPU_INT16U   USBD_Audio_MU_Tbl[APP_CFG_USBD_AUDIO_NBR_ENTITY][USBD_AUDIO_MU_MAX_INPUT * USBD_AUDIO_MAX_LOG_CH][USBD_AUDIO_MAX_LOG_CH];

static  CPU_INT08U   USBD_Audio_SU_Tbl[APP_CFG_USBD_AUDIO_NBR_ENTITY];

static  CPU_INT32U   USBD_Audio_AS_EP_SamplingFreqTbl[APP_CFG_USBD_AUDIO_NBR_ENTITY];

static  CPU_BOOLEAN  USBD_Audio_AS_EP_PitchTbl[APP_CFG_USBD_AUDIO_NBR_ENTITY];
                                  ...
                                  USBD_ERR        *p_err)
{
    ...
    Mem_Clr((void *)&USBD_Audio_OT_CopyProtTbl[0u],
                    (APP_CFG_USBD_AUDIO_NBR_ENTITY * (sizeof(CPU_INT08U))));

    Mem_Clr((void *)&USBD_Audio_FU_MuteTbl[0u][0u],
                    (APP_CFG_USBD_AUDIO_NBR_ENTITY * USBD_AUDIO_MAX_LOG_CH * (sizeof(CPU_BOOLEAN))));

    Mem_Clr((void *)&USBD_Audio_FU_VolTbl[0u][0u],
                    (APP_CFG_USBD_AUDIO_NBR_ENTITY * USBD_AUDIO_MAX_LOG_CH * (sizeof(CPU_INT16U))));

    Mem_Clr((void *)&USBD_Audio_FU_BassTbl[0u][0u],
                    (APP_CFG_USBD_AUDIO_NBR_ENTITY * USBD_AUDIO_MAX_LOG_CH * (sizeof(CPU_INT08U))));
    ...
    Mem_Clr((void *)&USBD_Audio_FU_GraphicEqualizerTbl[0u][0u][0u],
                    (APP_CFG_USBD_AUDIO_NBR_ENTITY * USBD_AUDIO_MAX_LOG_CH * USBD_AUDIO_FU_GRAPHIC_EQUALIZER_MAX_BANDS * (sizeof(CPU_INT08U))));
    ...
    Mem_Clr((void *)&USBD_Audio_MU_Tbl[0u][0u][0u],
                    (APP_CFG_USBD_AUDIO_NBR_ENTITY * (USBD_AUDIO_MU_MAX_INPUT * USBD_AUDIO_MAX_LOG_CH) * USBD_AUDIO_MAX_LOG_CH * (sizeof(CPU_INT16U))));
    ...
    Mem_Clr((void *)&USBD_Audio_AS_EP_SamplingFreqTbl[0u],
                    (APP_CFG_USBD_AUDIO_NBR_ENTITY * (sizeof(CPU_INT32U))));

    Mem_Clr((void *)&USBD_Audio_AS_EP_PitchTbl[0u],
                    (APP_CFG_USBD_AUDIO_NBR_ENTITY * (sizeof(CPU_BOOLEAN))));\
...
*               DEF_FAIL, otherwise.
*
* Caller(s)   : USBD_Audio_Terminal_CopyProtManage().
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
*               DEF_FAIL, otherwise.
*
* Caller(s)   : USBD_Audio_FU_MuteManage().
*
...
*               DEF_FAIL, otherwise.
*
* Caller(s)   : USBD_Audio_FU_VolManage().
*
...
*               DEF_FAIL, otherwise.
*
* Caller(s)   : USBD_Audio_FU_BassManage().
*
...
*               DEF_FAIL, otherwise.
*
* Caller(s)   : USBD_Audio_FU_MidManage().
*
...
*               DEF_FAIL, otherwise.
*
* Caller(s)   : USBD_Audio_FU_TrebleManage().
*
...
*               DEF_FAIL, otherwise.
*
* Caller(s)   : USBD_Audio_FU_GraphicEqualizerManage().
*
                                                                  ...
                                                                  CPU_INT08U      *p_buf)
{
    ...
    switch (req) {
        ...
        case USBD_AUDIO_REQ_GET_MIN:
             DEF_BIT_SET(*p_bm_bands_present, USBD_AUDIO_FU_GRAPHIC_EQUALIZER_BAND_29);
             p_buf[0u] = 0x80u;                                 /* Ã¢â‚¬â€œ32.00 dB (see Note #1a).                            */
             req_ok    = DEF_OK;
             break;
...
*               DEF_FAIL, otherwise.
*
* Caller(s)   : USBD_Audio_FU_AutoGainManage().
*
...
*               DEF_FAIL, otherwise.
*
* Caller(s)   : USBD_Audio_FU_DlyManage().
*
...
*               DEF_FAIL, otherwise.
*
* Caller(s)   : USBD_Audio_FU_BassBoostManage().
*
...
*               DEF_FAIL, otherwise.
*
* Caller(s)   : USBD_Audio_FU_LoudnessManage().
*
...
*               DEF_FAIL, otherwise.
*
* Caller(s)   : USBD_Audio_MU_CtrlManage().
*
...
*               DEF_FAIL, otherwise.
*
* Caller(s)   : USBD_Audio_SU_SelectInPinManage().
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
*               DEF_FAIL, otherwise.
*
* Caller(s)   : USBD_Audio_AS_SamplingFreqManage().
*
...
*               DEF_FAIL, otherwise.
*
* Caller(s)   : USBD_Audio_AS_PitchManage().
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
*               DEF_FAIL, otherwise.
*
* Caller(s)   : USBD_Audio_AS_IF_Stop().
*
* Note(s)     : none.
*********************************************************************************************************
*/
