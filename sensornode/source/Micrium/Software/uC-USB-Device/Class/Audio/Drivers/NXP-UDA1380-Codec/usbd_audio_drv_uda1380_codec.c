...
*                                              TEMPLATE
*
* File          : usbd_audio_drv_uda1380_codec.c
* Version       : V4.05.00.00
* Programmer(s) : CM
*********************************************************************************************************
...
#define  USBD_AUDIO_DRV_CIRCULAR_AUDIO_BUF_SIZE          APP_CFG_USBD_AUDIO_PLAYBACK_NBR_BUF
#elif (AUDIO_FUNCTION == AUDIO_MICROPHONE)
#define  USBD_AUDIO_DRV_CIRCULAR_AUDIO_BUF_SIZE          APP_CFG_USBD_AUDIO_RECORD_NBR_BUF
#elif (AUDIO_FUNCTION == AUDIO_HEADSET)
#define  USBD_AUDIO_DRV_CIRCULAR_AUDIO_BUF_SIZE          DEF_MAX(APP_CFG_USBD_AUDIO_RECORD_NBR_BUF, \
...
typedef  struct  usbd_audio_drv_data {
    ...
    CPU_INT32U                   AS_SamplingFreqTbl[APP_CFG_USBD_AUDIO_NBR_ENTITY];
...
*               DEF_FAIL, otherwise.
*
* Caller(s)   : USBD_Audio_DrvStreamPlaybackTx().
*
* Note(s)     : none.
*********************************************************************************************************
*/
