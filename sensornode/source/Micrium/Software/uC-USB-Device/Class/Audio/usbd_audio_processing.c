...
* Return(s)   : None.
*
* Caller(s)   : USBD_Audio_AC_ClassReq().
*
* Note(s)     : None.
*********************************************************************************************************
*/
...
* Return(s)   : None.
*
* Caller(s)   : USBD_Audio_AS_ClassReq().
*
...
* Return(s)   : None.
*
* Caller(s)   : USBD_Audio_OS_RecordTask().
*
...
* Return(s)   : none.
*
* Caller(s)   : USBD_Audio_OS_PlaybackTask().
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
* Return(s)   : None.
*
* Caller(s)   : USBD_Audio_AS_AltSettingUpdate(),
*               USBD_Audio_AS_EP_CtrlProcess().
*
* Note(s)     : None.
*********************************************************************************************************
...
* Return(s)   : None.
*
* Caller(s)   : USBD_Audio_AC_Disconn(),
...
*               Null pointer,             otherwise.
*
* Caller(s)   : Audio Peripheral Driver.
*
...
* Return(s)   : None.
*
* Caller(s)   : USBD_URB_Cmpl() via 'p_urb->AsyncFnct()'.
*
...
* Return(s)   : none.
*
* Caller(s)   : USBD_Audio_RecordIsocCmpl().
*
...
*
* Caller(s)   : USBD_Audio_AS_IF_RingBufQInit(),
*               USBD_Audio_RecordIsocCmpl().
*
...
* Return(s)   : none.
*
* Caller(s)   : USBD_Audio_IsocPlaybackCmpl().
*
...
* Return(s)   : None.
*
* Caller(s)   : USBD_Audio_ProcPlaybackCorrExec().
*
...
* Return(s)   : none.
*
* Caller(s)   : USBD_Audio_AS_EP_CtrlProcess().
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
*               Null pointer,              otherwise.
*
* Caller(s)   : USBD_Audio_ProcPlaybackSynchCorrInit(),
*               USBD_Audio_ProcPlaybackSynchCorrExec().
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
* Return(s)   : none.
*
* Caller(s)   : USBD_Audio_IsocPlaybackSynchCmpl().
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
* Return(s)   : None.
*
* Caller(s)   : USBD_Audio_AC_TerminalCtrl().
*
...
* Return(s)   : None.
*
* Caller(s)   : USBD_Audio_AC_UnitCtrl().
*
...
*
* Caller(s)   : USBD_Audio_PlaybackPrime(),
*               USBD_Audio_PlaybackUsbBufSubmit(),
*               USBD_Audio_RecordBufGet().
*
* Note(s)     : none.
...
*
* Caller(s)   : USBD_Audio_PlaybackIsocCmpl(),
*               USBD_Audio_RecordTaskHandler().
*
* Note(s)     : none.
*
...
*
* Caller(s)   : USBD_Audio_PlaybackBufFree(),
*               USBD_Audio_RecordIsocCmpl().
*
* Note(s)     : none.
*********************************************************************************************************
...
*
* Caller(s)   : USBD_Audio_PlaybackBufFree(),
*               USBD_Audio_PlaybackCodecBufSubmit(),
*               USBD_Audio_PlaybackIsocCmpl(),
*               USBD_Audio_PlaybackPrime(),
*               USBD_Audio_PlaybackUsbBufSubmit(),
*               USBD_Audio_RecordBufGet(),
...
*
* Caller(s)   : USBD_Audio_PlaybackCorrBuiltIn(),
*               USBD_Audio_PlaybackCorrSynch(),
*               USBD_Audio_RecordCorrBuiltIn().
*
* Note(s)     : none.
