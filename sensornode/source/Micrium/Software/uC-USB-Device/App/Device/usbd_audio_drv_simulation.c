...
*
* File          : usbd_audio_drv_simulation.c
* Version       : V4.05.00
* Programmer(s) : OD
*                 CM
*********************************************************************************************************
...
#define  USBD_AUDIO_DRV_SIMULATION_CIRCULAR_AUDIO_BUF_SIZE         APP_CFG_USBD_AUDIO_RECORD_NBR_BUF
#else
#define  USBD_AUDIO_DRV_SIMULATION_CIRCULAR_AUDIO_BUF_SIZE         DEF_MAX(APP_CFG_USBD_AUDIO_RECORD_NBR_BUF, \
...
#define  USBD_AUDIO_DRV_SIMULATION_LOOP_MAX_NB_XFERS               DEF_MAX(APP_CFG_USBD_AUDIO_RECORD_NBR_BUF, \
                                                                           APP_CFG_USBD_AUDIO_PLAYBACK_NBR_BUF)
...
#error  "APP_CFG_USBD_AUDIO_DRV_SIMULATION_STK_SIZE not #define'd in 'app_usbd_cfg.h' [MUST be > 0]"
#endif


#ifndef  APP_CFG_USBD_AUDIO_DRV_SIMULATION_PRIO
#error  "APP_CFG_USBD_AUDIO_DRV_SIMULATION_PRIO not #define'd in 'app_usbd_cfg.h' [MUST be > 0]"
#endif
...
*               DEF_FAIL, otherwise.
*
* Caller(s)   : USBD_Audio_DrvSimulationLoopTask(),
*               USBD_Audio_DrvStreamPlaybackTx().
*
* Note(s)     : none.
*********************************************************************************************************
