...
#define  RX630_REG_USB_STANDBY_BASE_ADDR                 0x00080014u
#define  RX630_REG_USB_STANDBY                          (*(volatile  CPU_INT32U *)(RX630_REG_USB_STANDBY_BASE_ADDR + 0x000))

                                                                /* USB Interrupt Request Register                       */
#define  RX630_REG_INT_REQ_BASE_ADDR                     0x00087010u
#define  RX630_REG_USB_INT_REQ_1                        (*(volatile  CPU_INT08U *)(RX630_REG_INT_REQ_BASE_ADDR + 0x011))
#define  RX630_REG_USB_INT_REQ_2                        (*(volatile  CPU_INT08U *)(RX630_REG_INT_REQ_BASE_ADDR + 0x012))
#define  RX630_REG_USB_INT_REQ_3                        (*(volatile  CPU_INT08U *)(RX630_REG_INT_REQ_BASE_ADDR + 0x013))
#define  RX630_REG_USB_INT_REQ_4                        (*(volatile  CPU_INT08U *)(RX630_REG_INT_REQ_BASE_ADDR + 0x04A))

                                                                /* USB Interrupt Enable Register                        */
#define  RX630_REG_INT_EN_BASE_ADDR                      0x00087202u
#define  RX630_REG_USB_INT_EN_1                         (*(volatile  CPU_INT08U *)(RX630_REG_INT_EN_BASE_ADDR + 0x002))
#define  RX630_REG_USB_INT_EN_2                         (*(volatile  CPU_INT08U *)(RX630_REG_INT_EN_BASE_ADDR + 0x009))

                                                                /* USB Interrupt Priority Register                      */
#define  RX630_REG_INT_PRIO_BASE_ADDR                    0x00087300u
#define  RX630_REG_USB_INT_PRIO_1                       (*(volatile  CPU_INT08U *)(RX630_REG_INT_PRIO_BASE_ADDR + 0x021))
#define  RX630_REG_USB_INT_PRIO_2                       (*(volatile  CPU_INT08U *)(RX630_REG_INT_PRIO_BASE_ADDR + 0x022))
#define  RX630_REG_USB_INT_PRIO_3                       (*(volatile  CPU_INT08U *)(RX630_REG_INT_PRIO_BASE_ADDR + 0x023))
#define  RX630_REG_USB_INT_PRIO_4                       (*(volatile  CPU_INT08U *)(RX630_REG_INT_PRIO_BASE_ADDR + 0x05A))
...
*
* According to the RX630 Reference Manual, the USB Device Controller on the RX630 supports up
...
USBD_DRV_EP_INFO  USBD_DrvEP_InfoTbl_RX630[] = {
...
static USBD_DRV  *USBD_BSP_RX630_DrvPtr;
...
static  void  USBD_BSP_RSKRX630_Init   (USBD_DRV  *p_drv);
...
USBD_DRV_BSP_API   USBD_DrvBSP_RSKRX630 = {
    USBD_BSP_RSKRX630_Init,                                     /* Init board-specific USB controller dependencies.     */
...
static  void  USBD_BSP_RSKRX630_Init (USBD_DRV  *p_drv)
{
    USBD_BSP_RX630_DrvPtr  = p_drv;

    BSP_IntVectSet(              USB_VECT_USB0_D0FIFO0,
                  (CPU_FNCT_VOID)USBD_BSP_RX630_IntHandler);
    ...
    RX630_REG_USB_INT_EN_1   |=  (USB_D0FIFO0_INT_EN |
                                  USB_D1FIFO0_INT_EN |
                                  USB_USBI0_INT_EN);
    RX630_REG_USB_INT_EN_2   |=   USB_USBR0_INT_EN;

                                                                /* Clear any pending ISR.                               */
    RX630_REG_USB_INT_REQ_1   =   DEF_CLR;
    RX630_REG_USB_INT_REQ_2   =   DEF_CLR;
    RX630_REG_USB_INT_REQ_3   =   DEF_CLR;
    RX630_REG_USB_INT_REQ_4   =   DEF_CLR;
                                                                /* Set interrupt priority.                              */
    RX630_REG_USB_INT_PRIO_1 =  3u;                             /* USB0 D0FIFO0                                         */
    RX630_REG_USB_INT_PRIO_2 =  3u;                             /* USB0 D1FIFO0                                         */
    RX630_REG_USB_INT_PRIO_3 =  3u;                             /* USB0 USBI0                                           */
    RX630_REG_USB_INT_PRIO_4 =  3u;                             /* USB0 USBR0                                           */

    DEF_BIT_CLR(RX630_REG_USB_STANDBY, USB_STANDBY_USB0);       /* Transition the USB0 module from the stop state.      */
}


/*
*********************************************************************************************************
*                                    USBD_BSP_RX630_IntHandler()
*
...
#if      __RENESAS__
#pragma  interrupt  USBD_BSP_RX630_IntHandler
#endif

CPU_ISR  USBD_BSP_RX630_IntHandler (void)
{
    USBD_DRV      *p_drv;
    ...
    CPU_CRITICAL_EXIT();
    CPU_CRITICAL_EXIT();
    OSIntExit();                                                /* Notify  the OS of ISR exit                           */
}
