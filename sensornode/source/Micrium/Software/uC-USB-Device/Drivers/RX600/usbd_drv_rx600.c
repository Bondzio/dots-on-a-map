...
* Return(s)   : none.
*
* Caller(s)   : USBD_DevStart() via 'p_drv_api->Init()'.
*
...
*
* Caller(s)   : USBD_DevGetFrameNbr() via 'p_drv_api->GetFrameNbr()'.
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
* Return(s)   : none.
*
* Caller(s)   : USBD_CtrlOpen() via 'p_drv_api->EP_Open()',
...
* Return(s)   : none.
*
* Caller(s)   : USBD_CtrlOpen() via 'p_drv_api->EP_Close()',
...
* Return(s)   : none.
*
* Caller(s)   : USBD_EP_Process() via 'p_drv_api->EP_RxStart()',
...
*               0,                        otherwise.
*
* Caller(s)   : USBD_EP_Process() via 'p_drv_api->EP_Rx()',
...
*               0,                           otherwise.
*
* Caller(s)   : USBD_EP_Process() via 'p_drv_api->EP_Tx()',
...
* Return(s)   : none.
*
* Caller(s)   : USBD_EP_Process() via 'p_drv_api->EP_TxStart()',
...
* Return(s)   : none.
*
* Caller(s)   : USBD_EP_Process() via 'p_drv_api->EP_TxZLP()',
*               USBD_EP_Tx()      via 'p_drv_api->EP_TxZLP()',
*               USBD_EP_TxZLP()   via 'p_drv_api->EP_TxZLP()'.
*
...
*               DEF_FAIL, otherwise.
*
* Caller(s)   : USBD_EP_Close()  via 'p_drv_api->EP_Abort()',
*               USBD_EP_Rx()     via 'p_drv_api->EP_Abort()',
*               USBD_EP_Tx()     via 'p_drv_api->EP_Abort()',
...
*               DEF_FAIL, otherwise.
*
* Caller(s)   : Various internal functions.
*
* Note(s)     : none.
*********************************************************************************************************
*/
