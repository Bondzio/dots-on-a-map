...
{
#ifdef OS_DLIB_TLS_EN
    if ((p_tcb->Opt & OS_DLIB_OPT_TLS) != 0) {
        OS_DLIB_TLS_Start((void *)p_tcb);
    }
#else
    (void)&p_tcb;
#endif
