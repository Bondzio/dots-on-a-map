...
* Return(s)   : none.
*
* Caller(s)   : FS_FAT_LFN_DirEntryCreate(),
*               FS_FAT_SFN_DirEntryCreate().
*
...
* Return(s)   : none.
*
* Caller(s)   : FS_FAT_LowDirFirstClusAdd(),
*               FS_FAT_SFN_DirEntryCreate(),
*               FS_FAT_SFN_DirEntryCreateAt(),
...
* Return(s)   : none.
*
* Caller(s)   : FS_FAT_SFN_DirEntryFind(),
...
* Return(s)   : none.
*
* Caller(s)   : FS_FAT_JournalChkDirEntryCreate().
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
* Return(s)   : none.
*
* Caller(s)   : FS_FAT_SFN_NextDirEntryGet().
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
* Return(s)   : none.
*
* Caller(s)   : FS_FAT_SFN_DirEntryCreate(),
*               FS_FAT_SFN_LabelSet().
*
* Note(s)     : (1) (a) The 'p_temp' pointer is 4-byte aligned since all sectors are 4-byte aligned.
*
...
* Return(s)   : Location of directory entry within buffer.
*
* Caller(s)   : FS_FAT_SFN_DirEntryPlace().
*
* Note(s)     : none.
*********************************************************************************************************
*/
