...
* Return(s)   : none.
*
* Caller(s)   : FS_FAT_FAT12_ClusAlloc(),
*               FS_FAT_FAT12_ClusLink(),
*               FS_FAT_FAT12_ClusChainDel(),
*               FS_FAT_FAT12_ClusNextGetAlloc().
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
*
* Caller(s)   : FS_FAT_FAT12_ClusChainDel(),
*               FS_FAT_FAT12_ClusChainFollow(),
*               FS_FAT_FAT12_ClusNextGet(),
*               FS_FAT_FAT12_ClusNextGetAlloc(),
*               FS_FAT_FAT12_Query(),
*               FS_FAT_FAT12_ClusFreeFind().
*
* Note(s)     : none.
*********************************************************************************************************
*/
