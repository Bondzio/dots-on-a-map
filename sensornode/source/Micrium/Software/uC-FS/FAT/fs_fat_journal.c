...
* Return(s)   : none.
*
* Caller(s)   : FS_FAT_EntryAttribSet(),
*               FS_FAT_EntryCreate(),
*               FS_FAT_EntryDel(),
*               FS_FAT_EntryRename(),
*               FS_FAT_EntryTimeSet(),
...
* Return(s)   : none.
*
* Caller(s)   : FS_FAT_LFN_DirEntryCreateAt(),
                                        ...
                                        FS_ERR  *p_err)
{
    ...
    MEM_VAL_SET_INT08U((void *)(p_dir_entry + FS_FAT_DIRENT_OFF_ATTR),       p_journal_data->Attrib);
    MEM_VAL_SET_INT16U((void *)(p_dir_entry + FS_FAT_DIRENT_OFF_FSTCLUSHI),  p_journal_data->FileFirstClus >> DEF_INT_16_NBR_BITS);
    MEM_VAL_SET_INT16U((void *)(p_dir_entry + FS_FAT_DIRENT_OFF_FSTCLUSLO),  p_journal_data->FileFirstClus &  DEF_INT_16_MASK);
    MEM_VAL_SET_INT16U((void *)(p_dir_entry + FS_FAT_DIRENT_OFF_WRTTIME),    time_val);
    MEM_VAL_SET_INT16U((void *)(p_dir_entry + FS_FAT_DIRENT_OFF_WRTDATE),    date_val);
    MEM_VAL_SET_INT16U((void *)(p_dir_entry + FS_FAT_DIRENT_OFF_LSTACCDATE), date_val);
    MEM_VAL_SET_INT32U((void *)(p_dir_entry + FS_FAT_DIRENT_OFF_FILESIZE),   p_journal_data->FileSize);
...
*
* Caller(s)   : FS_FAT_JournalPeek(),
*               FS_FAT_JournalRd_INT08U/16U/32U(),
...
* Return(s)   : none.
*
* Caller(s)   : FS_FAT_JournalEnterClusChainAlloc(),
*               FS_FAT_JournalEnterClusChainDel(),
*               FS_FAT_JournalEnterEntryCreate(),
*               FS_FAT_JournalEnterEntryUpdate().
*
