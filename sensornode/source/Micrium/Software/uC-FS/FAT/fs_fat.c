...
* Return(s)   : none.
*
* Caller(s)   : FS_FAT_ClusChainAlloc(),
*               FS_FAT_JournalReplayClusChainAlloc().
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
* Return(s)   : Cluster number of the last valid cluster found.
*
* Caller(s)   : FS_FAT_JournalReplayClusChainDel().
*
...
*               0,              otherwise.
*
* Caller(s)   : FS_FAT_ClusAlloc(),
*               FS_FAT_ClusNextGetAlloc().
*
                                   ...
                                   FS_ERR          *p_err)
{
    ...
    if (p_fat_data->FAT_Type != FS_FAT_FAT_TYPE_FAT32) {
        if (start_sec < p_fat_data->DataStart) {                /* If start sec outside data          ...               */
            ...
            FS_TRACE_DBG(("FS_FAT_SecNextGet(): Root dir full, no sec could be alloc'd.\r\n"));
...
*               0,                  otherwise.
*
* Caller(s)   : FS_FAT_LFN_DirEntryPlace(),
                                        ...
                                        FS_ERR          *p_err)
{
    ...
    if (p_fat_data->FAT_Type != FS_FAT_FAT_TYPE_FAT32) {
        if (start_sec < p_fat_data->DataStart) {                /* If start sec outside data          ...               */
            ...
            FS_TRACE_DBG(("FS_FAT_SecNextGetAlloc(): Root dir full, no sec could be alloc'd.\r\n"));
           *p_err = FS_ERR_DIR_FULL;
            return (0u);
        }
    }
...
* Return(s)   : none.
*
* Caller(s)   : FS_FAT_LowEntryCreate().
*
*               This function is an INTERNAL file system suite function & MUST NOT be called by
*               application function(s).
*
...
* Caller(s)   : FS_FAT_LowEntryFind(),
*               FS_FAT_LowEntryRename(),
*               FS_FAT_JournalReplayEntryCreate().
*
*               This function is an INTERNAL file system suite function & MUST NOT be called by
*               application function(s).
*
...
* Return(s)   : none.
*
* Caller(s)   : FS_FAT_EntryRename(),
*               FS_FAT_JournalReplayEntryRename().
*
*               This function is an INTERNAL file system suite function & MUST NOT be called by
*               application function(s).
*
...
* Caller(s)   : FS_FAT_LowEntryFind(),
*               FS_FAT_LowEntryRename(),
*               FS_FAT_JournalReplayEntryTruncate(),
*               FS_FAT_FileTruncate().
*
*               This function is an INTERNAL file system suite function & MUST NOT be called by
*               application function(s).
...
*
* Caller(s)   : FS_FAT_LowEntryUpdate(),
*               FS_FAT_EntryTimeSet(),
    ...
    while (DEF_ON) {
        ...
        switch (*p_err) {
            ...
            case FS_ERR_NONE:                                   /* ------------------ DIR ENTRY FOUND ----------------- */
                 ...
                 if (FS_FAT_IS_VALID_CLUS(p_fat_data, dir_first_clus) == DEF_NO) {
                    *p_err = FS_ERR_VOL_INVALID_SEC_NBR;
                     return;
                 }
