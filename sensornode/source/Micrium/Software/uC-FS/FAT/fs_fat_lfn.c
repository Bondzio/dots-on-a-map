...
*               FS_FAT_JournalChkDirEntryCreate().
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
*
* Caller(s)   : FS_FAT_LFN_NextDirEntryGet().
*
...
*               0,                  otherwise.
*
* Caller(s)   : FS_FAT_LFN_SFN_DirEntryFindMax().
*
* Note(s)     : (1) (a) The 'p_temp' pointer is 4-byte aligned since all sectors are 4-byte aligned.
*
*                   (b) All pointers to directory entries are 4-byte aligned since all directory entries
...
*
* Caller(s)   : FS_FAT_LFN_DirEntryFind().
*
* Note(s)     : none.
*********************************************************************************************************
*/
