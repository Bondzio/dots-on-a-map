...
*
*                      ST STM32F103VB ON THE ST STM3210B-EVAL EVALUATION BOARD
*
...
#define  STM32_PIN_SD_CS                            DEF_BIT_12  /* GPIOC.12                                             */
...
static  CPU_BOOLEAN  FSDev_BSP_SPI_Open (FS_QTY  unit_nbr)
{
    ...
    STM32_REG_RCC_APB2RSTR &= ~(DEF_BIT_12 | DEF_BIT_02 | DEF_BIT_04);
    STM32_REG_RCC_APB2ENR  |=  (DEF_BIT_12 | DEF_BIT_02 | DEF_BIT_04);      /* En SPI1, GPIOA, GPIOC clks.              */
    ...
    temp                 = STM32_REG_GPIOC_CRH;                 /* Cfg SD CS as general purpose output.                 */
    temp                &= 0xFFF0FFFFu;
    temp                |= 0x00030000u;
...
static  void  FSDev_BSP_SPI_ChipSelEn (FS_QTY  unit_nbr)
{
   (void)&unit_nbr;                                             /* Prevent compiler warning.                            */
    ...
    STM32_REG_GPIOC_BSRR = DEF_BIT_28;
}
...
static  void  FSDev_BSP_SPI_ChipSelDis (FS_QTY  unit_nbr)
{
   (void)&unit_nbr;                                             /* Prevent compiler warning.                            */
    ...
    STM32_REG_GPIOC_BSRR = DEF_BIT_12;
}
