...
*
*                       ATMEL AT91SAM9XE ON THE AT91SAM9XE-EK EVALUATION BOARD
*
* Filename      : fs_dev_sd_card_bsp.c
* Version       : v4.07.00
* Programmer(s) : BAN
*********************************************************************************************************
* Note(s)       : (1) The AT91SAM9XE SD/MMC card interface is described in documentation from Atmel :
*
*                         AT91SAM9XE128/AT91SAM9XE256/AT91SAM9XE512.  6254A-ATARM-01-Feb-08.  "37:
*                         MultiMedia Card Interface (MCI)".
*
*                 (2) AT91SAM9_MCLK_FREQ should be set to the value of the AT91SAM9XE's MCLK frequency.
*********************************************************************************************************
*/
...
#define  AT91SAM9_GPIO_MC_DB0                     DEF_BIT_00   /* PA0 (peripheral B).                                  */
#define  AT91SAM9_GPIO_MC_DB1                     DEF_BIT_05   /* PA5 (peripheral B).                                  */
#define  AT91SAM9_GPIO_MC_DB2                     DEF_BIT_04   /* PA4 (peripheral B).                                  */
#define  AT91SAM9_GPIO_MC_DB3                     DEF_BIT_03   /* PA3 (peripheral B).                                  */
#define  AT91SAM9_GPIO_MC_CDB                     DEF_BIT_01   /* PA1 (peripheral B).                                  */
#define  AT91SAM9_GPIO_MC_CK                      DEF_BIT_08   /* PA8 (peripheral A).                                  */
...
*
*               (2) A SD/MMC slot is connected to the AT91SAM9XE using the following pins :
*
*                   ----------------------------------------------------
*                   | AT91SAM9XE NAME | AT91SAM9XE PIO # | SD/MMC NAME |
*                   ----------------------------------------------------
*                   |     MC_DB0      |       PA0        |     DAT0    |
*                   |     MC_DB1      |       PA5        |     DAT1    |
*                   |     MC_DB2      |       PA4        |     DAT2    |
...
CPU_BOOLEAN  FSDev_SD_Card_BSP_Open (FS_QTY  unit_nbr)
{
    ...
    AT91SAM9_REG_PIOA_PDR   = AT91SAM9_GPIO_MC_DB0 | AT91SAM9_GPIO_MC_DB1 | AT91SAM9_GPIO_MC_DB2 | AT91SAM9_GPIO_MC_DB3 | AT91SAM9_GPIO_MC_CDB | AT91SAM9_GPIO_MC_CK;
    AT91SAM9_REG_PIOA_ASR   = AT91SAM9_GPIO_MC_CK;
    AT91SAM9_REG_PIOA_BSR   = AT91SAM9_GPIO_MC_DB0 | AT91SAM9_GPIO_MC_DB1 | AT91SAM9_GPIO_MC_DB2 | AT91SAM9_GPIO_MC_DB3 | AT91SAM9_GPIO_MC_CDB | AT91SAM9_GPIO_MC_CK;
    AT91SAM9_REG_PIOA_PPUDR = AT91SAM9_GPIO_MC_DB0 | AT91SAM9_GPIO_MC_DB1 | AT91SAM9_GPIO_MC_DB2 | AT91SAM9_GPIO_MC_DB3 | AT91SAM9_GPIO_MC_CDB | AT91SAM9_GPIO_MC_CK;
    AT91SAM9_REG_PIOA_MDDR  = AT91SAM9_GPIO_MC_DB0 | AT91SAM9_GPIO_MC_DB1 | AT91SAM9_GPIO_MC_DB2 | AT91SAM9_GPIO_MC_DB3 | AT91SAM9_GPIO_MC_CDB | AT91SAM9_GPIO_MC_CK;
    ...
    p_mci->MCI_SDCR = AT91SAM9_BIT_MCI_SDCR_SCSEL_B;                                /* Set init mode.                   */
