...
*
*                         AT91SAM9263.  6258G-ATARM-06-Jan-09.  "40: MultiMedia Card Interface (MCI)".
*
*                 (2) AT91SAM9_MCLK_FREQ should be set to the value of the AT91SAM9263's MCLK frequency.
*********************************************************************************************************
*/
...
#define  AT91SAM9_GPIO_MC0_DA0                    DEF_BIT_00    /* PA0  (peripheral A).                                 */
#define  AT91SAM9_GPIO_MC0_DA1                    DEF_BIT_03    /* PA3  (peripheral A).                                 */
#define  AT91SAM9_GPIO_MC0_DA2                    DEF_BIT_04    /* PA4  (peripheral A).                                 */
#define  AT91SAM9_GPIO_MC0_DA3                    DEF_BIT_05    /* PA5  (peripheral A).                                 */
#define  AT91SAM9_GPIO_MC0_CDA                    DEF_BIT_01    /* PA1  (peripheral A).                                 */
#define  AT91SAM9_GPIO_MC0_CK                     DEF_BIT_12    /* PA12 (peripheral A).                                 */

#define  AT91SAM9_GPIO_MC1_DA0                    DEF_BIT_08    /* PA8  (peripheral A).                                 */
#define  AT91SAM9_GPIO_MC1_DA1                    DEF_BIT_09    /* PA9  (peripheral A).                                 */
#define  AT91SAM9_GPIO_MC1_DA2                    DEF_BIT_10    /* PA10 (peripheral A).                                 */
#define  AT91SAM9_GPIO_MC1_DA3                    DEF_BIT_11    /* PA11 (peripheral A).                                 */
#define  AT91SAM9_GPIO_MC1_CDA                    DEF_BIT_07    /* PA7  (peripheral A).                                 */
#define  AT91SAM9_GPIO_MC1_CK                     DEF_BIT_06    /* PA6  (peripheral A).                                 */

#define  AT91SAM9_INT_ID_MCI0                             10u
#define  AT91SAM9_PERIPH_ID_MCI0                          10u

#define  AT91SAM9_INT_ID_MCI1                             11u
#define  AT91SAM9_PERIPH_ID_MCI1                          11u

#define  AT91SAM9_PERIPH_ID_PIOA                           2u
#define  AT91SAM9_PERIPH_ID_PIOCDE                         4u
...
#define  AT91SAM9_REG_PIOA_BASE                             0xFFFFF200u
...
#define  AT91SAM9_REG_PIOE_BASE                             0xFFFFFA00u
#define  AT91SAM9_REG_PIOE_PER              (*(CPU_REG32 *)(AT91SAM9_REG_PIOE_BASE + 0x000u))
#define  AT91SAM9_REG_PIOE_OER              (*(CPU_REG32 *)(AT91SAM9_REG_PIOE_BASE + 0x010u))
#define  AT91SAM9_REG_PIOE_CODR             (*(CPU_REG32 *)(AT91SAM9_REG_PIOE_BASE + 0x034u))
...
#define  AT91SAM9_REG_MCI0_BASE                              0xFFF80000u
#define  AT91SAM9_REG_MCI1_BASE                              0xFFF84000u
...
static  FS_ERR     FSDev_SD_Card_BSP_Err0;
static  FS_ERR     FSDev_SD_Card_BSP_Err1;
static  FS_OS_SEM  FSDev_SD_Card_OS_Sem0;
static  FS_OS_SEM  FSDev_SD_Card_OS_Sem1;
...
static  void  FSDev_SD_Card_BSP_ISR_Handler0(void);

static  void  FSDev_SD_Card_BSP_ISR_Handler1(void);

static  void  FSDev_SD_Card_BSP_ISR_Handler (FS_QTY  unit_nbr);
...
*
*               (2) Two SD/MMC slots are connected to the AT91SAM9263 using the following pins :
*
*                   ---------------------------------------------------------------
*                   | AT91SAM9263 NAME | AT91SAM9263 PIO # | SD/MMC NAME |  SLOT  |
*                   ---------------------------------------------------------------
*                   |     MC0_DA0      |        PA0        |     DAT0    |   0    |
*                   |     MC0_DA1      |        PA3        |     DAT1    |   0    |
*                   |     MC0_DA2      |        PA4        |     DAT2    |   0    |
...
*                   ---------------------------------------------------------------
*
*                   In addition, an external signal on PE20 is used to select the clock signal which
*                   drives the card in slot 0; this must be high for the MCI clock signal to be connected.
*********************************************************************************************************
*/
...
CPU_BOOLEAN  FSDev_SD_Card_BSP_Open (FS_QTY  unit_nbr)
{
    ...
    if (unit_nbr == 0u) {                                                               /* -------- CREATE SEM -------- */
        ok = FS_OS_SemCreate(&FSDev_SD_Card_OS_Sem0, 0u);
        if (ok == DEF_FAIL) {
            FS_TRACE_INFO(("FSDev_SD_Card_BSP_Open(): Could not create sem.\r\n"));
            return (DEF_FAIL);
        }
        p_mci = (AT91SAM9_STRUCT_MCI *)AT91SAM9_REG_MCI0_BASE;
    } else {
        ok = FS_OS_SemCreate(&FSDev_SD_Card_OS_Sem1, 0u);
        if (ok == DEF_FAIL) {
            FS_TRACE_INFO(("FSDev_SD_Card_BSP_Open(): Could not create sem.\r\n"));
            return (DEF_FAIL);
        }
        p_mci = (AT91SAM9_STRUCT_MCI *)AT91SAM9_REG_MCI1_BASE;
    }

                                                                                    /* ------------ EN MCI ------------ */
    if (unit_nbr == 0u) {                                                           /* Cfg GPIO.                        */
        AT91SAM9_REG_PIOA_PDR   = AT91SAM9_GPIO_MC0_DA0 | AT91SAM9_GPIO_MC0_DA1 | AT91SAM9_GPIO_MC0_DA2 | AT91SAM9_GPIO_MC0_DA3 | AT91SAM9_GPIO_MC0_CDA | AT91SAM9_GPIO_MC0_CK;
        AT91SAM9_REG_PIOA_ASR   = AT91SAM9_GPIO_MC0_DA0 | AT91SAM9_GPIO_MC0_DA1 | AT91SAM9_GPIO_MC0_DA2 | AT91SAM9_GPIO_MC0_DA3 | AT91SAM9_GPIO_MC0_CDA | AT91SAM9_GPIO_MC0_CK;
        AT91SAM9_REG_PIOA_PPUDR = AT91SAM9_GPIO_MC0_DA0 | AT91SAM9_GPIO_MC0_DA1 | AT91SAM9_GPIO_MC0_DA2 | AT91SAM9_GPIO_MC0_DA3 | AT91SAM9_GPIO_MC0_CDA | AT91SAM9_GPIO_MC0_CK;
        AT91SAM9_REG_PIOA_MDDR  = AT91SAM9_GPIO_MC0_DA0 | AT91SAM9_GPIO_MC0_DA1 | AT91SAM9_GPIO_MC0_DA2 | AT91SAM9_GPIO_MC0_DA3 | AT91SAM9_GPIO_MC0_CDA | AT91SAM9_GPIO_MC0_CK;

        AT91SAM9_REG_PIOE_PER   = DEF_BIT_20;
        AT91SAM9_REG_PIOE_OER   = DEF_BIT_20;
        AT91SAM9_REG_PIOE_CODR  = DEF_BIT_20;

        AT91SAM9_REG_PMC_PCER   = DEF_BIT(AT91SAM9_PERIPH_ID_MCI0);                 /* En periph clk.                   */
        AT91SAM9_REG_AIC_IDCR   = DEF_BIT(AT91SAM9_INT_ID_MCI0);

    } else {                                                                        /* Cfg GPIO.                        */
        AT91SAM9_REG_PIOA_PDR   = AT91SAM9_GPIO_MC1_DA0 | AT91SAM9_GPIO_MC1_DA1 | AT91SAM9_GPIO_MC1_DA2 | AT91SAM9_GPIO_MC1_DA3 | AT91SAM9_GPIO_MC1_CDA | AT91SAM9_GPIO_MC1_CK;
        AT91SAM9_REG_PIOA_ASR   = AT91SAM9_GPIO_MC1_DA0 | AT91SAM9_GPIO_MC1_DA1 | AT91SAM9_GPIO_MC1_DA2 | AT91SAM9_GPIO_MC1_DA3 | AT91SAM9_GPIO_MC1_CDA | AT91SAM9_GPIO_MC1_CK;
        AT91SAM9_REG_PIOA_PPUDR = AT91SAM9_GPIO_MC1_DA0 | AT91SAM9_GPIO_MC1_DA1 | AT91SAM9_GPIO_MC1_DA2 | AT91SAM9_GPIO_MC1_DA3 | AT91SAM9_GPIO_MC1_CDA | AT91SAM9_GPIO_MC1_CK;
        AT91SAM9_REG_PIOA_MDDR  = AT91SAM9_GPIO_MC1_DA0 | AT91SAM9_GPIO_MC1_DA1 | AT91SAM9_GPIO_MC1_DA2 | AT91SAM9_GPIO_MC1_DA3 | AT91SAM9_GPIO_MC1_CDA | AT91SAM9_GPIO_MC1_CK;

        AT91SAM9_REG_PMC_PCER   = DEF_BIT(AT91SAM9_PERIPH_ID_MCI1);                 /* En periph clk.                   */
        AT91SAM9_REG_AIC_IDCR   = DEF_BIT(AT91SAM9_INT_ID_MCI1);
    }
    AT91SAM9_REG_PMC_PCER = DEF_BIT(AT91SAM9_PERIPH_ID_PIOA) | DEF_BIT(AT91SAM9_PERIPH_ID_PIOCDE);
    ...
    if (unit_nbr == 0u) {                                                           /* Dis periph clk.                  */
        AT91SAM9_REG_PMC_PCDR = DEF_BIT(AT91SAM9_PERIPH_ID_MCI0);
    } else {
        AT91SAM9_REG_PMC_PCDR = DEF_BIT(AT91SAM9_PERIPH_ID_MCI1);
    }

                                                                                    /* ------------ CFG INT ----------- */
                                                                                    /* Set int handler.                 */
    if (unit_nbr == 0u) {
        AT91SAM9_REG_AIC_SVR(AT91SAM9_INT_ID_MCI0) = (CPU_INT32U)FSDev_SD_Card_BSP_ISR_Handler0;
        AT91SAM9_REG_AIC_SMR(AT91SAM9_INT_ID_MCI0) =  0u;
        AT91SAM9_REG_AIC_IECR                      =  DEF_BIT(AT91SAM9_INT_ID_MCI0);

    } else {
        AT91SAM9_REG_AIC_SVR(AT91SAM9_INT_ID_MCI1) = (CPU_INT32U)FSDev_SD_Card_BSP_ISR_Handler1;
        AT91SAM9_REG_AIC_SMR(AT91SAM9_INT_ID_MCI1) =  0u;
        AT91SAM9_REG_AIC_IECR                      =  DEF_BIT(AT91SAM9_INT_ID_MCI1);
    }
    ...
    if (unit_nbr == 0) {                                                                /* Wait for completion.         */
       (void)FS_OS_SemPend(&FSDev_SD_Card_OS_Sem0, AT91SAM9_WAIT_TIMEOUT_ms);
    } else {
       (void)FS_OS_SemPend(&FSDev_SD_Card_OS_Sem1, AT91SAM9_WAIT_TIMEOUT_ms);
    }
...
void  FSDev_SD_Card_BSP_Close (FS_QTY  unit_nbr)
{
    ...
    if (unit_nbr == 0u) {
        ok = FS_OS_SemDel(&FSDev_SD_Card_OS_Sem0);                /* Del sem.                                         */
        if (ok == DEF_FAIL) {
            FS_TRACE_INFO(("FSDev_SD_Card_BSP_Close(): Could not del sem.\r\n"));
        }
        AT91SAM9_REG_AIC_IDCR = DEF_BIT(AT91SAM9_INT_ID_MCI0);      /* Dis MCI int.                                     */
        AT91SAM9_REG_PMC_PCDR = DEF_BIT(AT91SAM9_PERIPH_ID_MCI0);   /* Dis periph clk.                                  */


    } else {
        ok = FS_OS_SemDel(&FSDev_SD_Card_OS_Sem1);                /* Del sem.                                         */
        if (ok == DEF_FAIL) {
            FS_TRACE_INFO(("FSDev_SD_Card_BSP_Close(): Could not del sem.\r\n"));
        }
        AT91SAM9_REG_AIC_IDCR = DEF_BIT(AT91SAM9_INT_ID_MCI1);      /* Dis MCI int.                                     */
        AT91SAM9_REG_PMC_PCDR = DEF_BIT(AT91SAM9_PERIPH_ID_MCI1);   /* Dis periph clk.                                  */
    }
}
                                    ...
                                    FS_DEV_SD_CARD_ERR  *p_err)
{
    ...
    if (unit_nbr == 0u) {
        p_mci = (AT91SAM9_STRUCT_MCI *)AT91SAM9_REG_MCI0_BASE;
        ok = FS_OS_SemPend(&FSDev_SD_Card_OS_Sem0, 1000u);        /* Wait for completion.                             */

    } else {
        p_mci = (AT91SAM9_STRUCT_MCI *)AT91SAM9_REG_MCI1_BASE;
        ok = FS_OS_SemPend(&FSDev_SD_Card_OS_Sem1, 1000u);        /* Wait for completion.                             */
    }
    ...
    if (ok == DEF_OK) {
        if (unit_nbr == 0u) {
           *p_err = FSDev_SD_Card_BSP_Err0;
        } else {
           *p_err = FSDev_SD_Card_BSP_Err1;
        }
                                                                /* If stop cmd ...                                      */
...
* Return(s)   : none.
*
* Caller(s)   : FSDev_SD_Card_BSP_ISR_Handler0(),
*               FSDev_SD_Card_BSP_ISR_Handler1().
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
static  void  FSDev_SD_Card_BSP_ISR_Handler (FS_QTY  unit_nbr)
{
    ...
    if (unit_nbr == 0u) {
        FSDev_SD_Card_BSP_Err0 = err;
    } else {
        FSDev_SD_Card_BSP_Err1 = err;
    }

    if (post == DEF_YES) {
        if (unit_nbr == 0u) {
           (void)FS_OS_SemPost(&FSDev_SD_Card_OS_Sem0);
        } else {
           (void)FS_OS_SemPost(&FSDev_SD_Card_OS_Sem1);
        }
    }
}
...
/*
*********************************************************************************************************
*                                  FSDev_SD_Card_BSP_ISR_Handler0()
*
* Description : Handle MCI0 interrupt.
*
* Argument(s) : none.
*
* Return(s)   : none.
...
static  void  FSDev_SD_Card_BSP_ISR_Handler0 (void)
{
    FSDev_SD_Card_BSP_ISR_Handler(0u);

    AT91SAM9_REG_AIC_IVR  = 0u;
    AT91SAM9_REG_AIC_ICCR = DEF_BIT(AT91SAM9_INT_ID_MCI0);
}
...
*                                  FSDev_SD_Card_BSP_ISR_Handler1()
*
* Description : Handle MCI1 interrupt.
*
* Argument(s) : none.
*
* Return(s)   : none.
...
static  void  FSDev_SD_Card_BSP_ISR_Handler1 (void)
{
    FSDev_SD_Card_BSP_ISR_Handler(1u);

    AT91SAM9_REG_AIC_IVR  = 0u;
    AT91SAM9_REG_AIC_ICCR = DEF_BIT(AT91SAM9_INT_ID_MCI1);
}
