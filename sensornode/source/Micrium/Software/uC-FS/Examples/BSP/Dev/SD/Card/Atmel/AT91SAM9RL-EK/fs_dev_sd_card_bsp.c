...
*
*                      ATMEL AT91SAM9RL64 ON THE AT91SAM9RL-EK EVALUATION BOARD
*
* Filename      : fs_dev_sd_card_bsp.c
* Version       : v4.07.00
* Programmer(s) : BAN
*********************************************************************************************************
* Note(s)       : (1) The AT91SAM9RL SD/MMC card interface is described in documentation from Atmel :
*
*                         AT91SAM9R64/AT91SAM9RL64.  6289B-ATARM-17-Oct-08.  "38: MultiMedia Card
*                         Interface (MCI)".
*
*                 (2) AT91SAM9_MCLK_FREQ should be set to the value of the AT91SAM9RL's MCLK frequency.
*********************************************************************************************************
*/
...
#define  AT91SAM9_GPIO_MC_DA0                     DEF_BIT_00   /* PA0 (peripheral A).                                  */
#define  AT91SAM9_GPIO_MC_DA1                     DEF_BIT_03   /* PA3 (peripheral A).                                  */
#define  AT91SAM9_GPIO_MC_DA2                     DEF_BIT_04   /* PA4 (peripheral A).                                  */
#define  AT91SAM9_GPIO_MC_DA3                     DEF_BIT_05   /* PA5 (peripheral A).                                  */
#define  AT91SAM9_GPIO_MC_CDA                     DEF_BIT_01   /* PA1 (peripheral A).                                  */
#define  AT91SAM9_GPIO_MC_CK                      DEF_BIT_02   /* PA2 (peripheral A).                                  */

#define  AT91SAM9_INT_ID_MCI                              10u
#define  AT91SAM9_PERIPH_ID_MCI                           10u
...
#define  AT91SAM9_REG_MCI_BASE                               0xFFFA4000u
...
*
*               (2) A SD/MMC slot is connected to the AT91SAM9RL using the following pins :
*
*                   ----------------------------------------------------
*                   | AT91SAM9RL NAME | AT91SAM9RL PIO # | SD/MMC NAME |
*                   ----------------------------------------------------
*                   |     MC_DA0      |       PA0        |     DAT0    |
*                   |     MC_DA1      |       PA3        |     DAT1    |
*                   |     MC_DA2      |       PA4        |     DAT2    |
...
CPU_BOOLEAN  FSDev_SD_Card_BSP_Open (FS_QTY  unit_nbr)
{
    ...
    AT91SAM9_REG_PIOA_ASR   = AT91SAM9_GPIO_MC_DA0 | AT91SAM9_GPIO_MC_DA1 | AT91SAM9_GPIO_MC_DA2 | AT91SAM9_GPIO_MC_DA3 | AT91SAM9_GPIO_MC_CDA | AT91SAM9_GPIO_MC_CK;
