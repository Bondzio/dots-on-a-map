...
*
* Caller(s)   : FSDev_GetNbrPartitions().
*
...
*
* Caller(s)   : FSPartition_GetNbrPartitions().
*
* Note(s)     : none.
*********************************************************************************************************
*/
