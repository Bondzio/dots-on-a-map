...
* Return(s)   : none.
*
* Caller(s)   : FS_Init(),     (FULL        BUILD)
*               Application.   (DEVICE-ONLY BUILD)
*
*               In the FULL BUILD,        this function is an INTERNAL file system suite function & MUST
*                                         NOT be called by application function(s).
*
*               In the DEVICE-ONLY BUILD, this function is a file system suite application interface (API)
*                                         function & MAY be called by application function(s).
*
*               See 'fs_cfg.h  FILE SYSTEM BUILD CONFIGURATION  Note #1'.
*
                        ...
                        FS_ERR  *p_err)
{
    ...
    FSDev_DevCntMax = dev_cnt;
                                                                ...
                                                                /* ----------------- INIT DEV DRV TBL ----------------- */
    FS_DevDrvTbl = Mem_HeapAlloc(dev_drv_cnt * sizeof(FS_DEV_API *),
                                 sizeof(CPU_ALIGN),
                                &octets_reqd,
                                &pool_err);
    if (pool_err != LIB_MEM_ERR_NONE) {
