...
struct  fs_nand_data {
    ...
    CPU_SIZE_T                OOS_BufSize;                      /* OOS size per sec.                                    */
...
*
*               This function is a file system suite application (API) function & MAY be called
                                    ...
                                    FS_ERR  *p_err)
{
    ...
    last_blk_ix             = p_nand_cfg->BlkIxFirst + p_nand_cfg->BlkCnt;
...
* Return(s)   : none.
*
* Caller(s)   : FS_NAND_LowFmtHandler().
*
* Note(s)     : none.
*********************************************************************************************************
*/
                                     ...
                                     FS_ERR           *p_err)
{
    ...
    oos_size_hdr = /*p_nand_data->OOS_BufSize*/FS_NAND_OOS_PARTIAL_SIZE_REQD;
...
*
* Caller(s)   : FS_NAND_LowMountHandler().
*
...
*
* Caller(s)   : FS_NAND_MetaSecWrHandler(),
*               FS_NAND_SUB_Merge(),
...
* Return(s)   : none.
*
* Caller(s)   : FS_NAND_BlkEnsureErased(),
*               FS_NAND_BlkRefresh(),
...
* Return(s)   : none.
*
* Caller(s)   : FS_NAND_AvailBlkTblFill(),
*               FS_NAND_BlkGetDirty().
*
    ...
    for (tbl_ix = 0u; tbl_ix < p_nand_data->AvailBlkTblEntryCntMax; tbl_ix++) {
        ...
        if (tbl_entry.BlkIxPhy != FS_NAND_BLK_IX_INVALID) {
            ...
            if (is_entry_committed == DEF_YES) {
                ...
                if (tbl_entry.EraseCnt       < min_erase_cnt_committed) {
                ...
                if (tbl_entry.EraseCnt       < min_erase_cnt) {
                                                      ...
                                                      FS_ERR        *p_err)
{
    ...
    word_ix_wrap   = p_nand_data->BlkCnt             >> 5u;
    ...
    do {
        ...
        if (dirty_found == DEF_NO) {
            word_ix++;
            if (word_ix == word_ix_wrap) { /* If this is the last word of the bitmap ...*/
                word_ix       =  0;                             /* ... wrap around.                                     */
            }
                ...
                *p_err    = FS_ERR_NONE;
                 ...
                 MEM_VAL_COPY_GET_INTU_LITTLE(&blk_type,
                                              &p_oos_buf[FS_NAND_OOS_SEC_TYPE_OFFSET],
                                               DEF_MIN(sizeof(FS_NAND_SEC_TYPE), sizeof(FS_NAND_SEC_TYPE_STO)));
                 break;
...
* Return(s)   : none.
*
* Caller(s)   : FS_NAND_MetaSecCommit(),
...
*
* Caller(s)   : FS_NAND_BlkGetFromDirty(),
*               FS_NAND_MetaBlkFold().
*
...
* Return(s)   : none.
*
* Caller(s)   : FS_NAND_AvailBlkTblInvalidate(),
...
* Return(s)   : none.
*
* Caller(s)   : FS_NAND_AvailBlkTblTmpCommit(),
*               FS_NAND_LowFmtHandler(),
*               FS_NAND_Wr(),
*               FS_NAND_Rd().
*
...
* Return(s)   : none.
*
* Caller(s)   : FS_NAND_BlkAddToAvail(),
*               FS_NAND_BlkUnmap(),
*               FS_NAND_MetaSecCommit(),
*               FS_NAND_OOSGenSto().
*
...
* Return(s)   : none.
*
* Caller(s)   : FS_NAND_RUB_PartialMerge(),
*               FS_NAND_SUB_Merge().
*
...
* Return(s)   : none.
*
* Caller(s)   : FS_NAND_IO_Ctrl() (FS_DEV_IO_CTRL_LOW_FMT).
*
...
* Return(s)   : none.
*
* Caller(s)   : FS_NAND_Open(),
*               FS_NAND_IO_Ctrl() (FS_DEV_IO_CTRL_LOW_MOUNT),
*               FS_NAND_LowFmtHandler().
*
* Note(s)     : none.
*********************************************************************************************************
...
FS_NAND_INTERN  FS_NAND_DATA  *FS_NAND_DataGet (void)
{
    ...
    CPU_CRITICAL_EXIT();
                                                                ...
                                                                /* --------------------- CLR DATA --------------------- */
    p_nand_data->CtrlrDataPtr = DEF_NULL;
