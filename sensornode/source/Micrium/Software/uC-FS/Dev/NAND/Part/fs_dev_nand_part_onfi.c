...
* Return(s)   : none.
*
* Caller(s)   : FS_NAND_PartONFI_Open().
*
* Note(s)     : none.
*********************************************************************************************************
*/
                                               ...
                                               FS_ERR             *p_err)
{
   ...
   *p_err = FS_ERR_NONE;
    ...
    rndm_pg_pgm  = DEF_BIT_IS_SET(FS_NAND_PartONFI_ParamPg[6], FS_NAND_PART_ONFI_FEATURE_RNDM_PG_PGM);
    if (rndm_pg_pgm == DEF_YES) {
        p_part_data->SupportsRndPgPgm = DEF_YES;
    } else {
        p_part_data->SupportsRndPgPgm =  DEF_NO;
    }
...
* Return(s)   : none.
*
* Caller(s)   : FS_NAND_PartONFI_Close().
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
static  FS_NAND_PART_DATA  *FS_NAND_PartONFI_DataGet (void)
{
    ...
    p_nand_part_data->SupportsRndPgPgm = 0;
