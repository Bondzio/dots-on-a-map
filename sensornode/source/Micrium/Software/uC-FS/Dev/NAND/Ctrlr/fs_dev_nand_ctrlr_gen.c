...
static  CPU_BOOLEAN              PollFcnt    (void                          *p_ctrlr_data_v);
                                 ...
                                 FS_ERR           *p_err)
{
    ...
    p_ctrlr_data->OOS_Offset =  p_part_data->FreeSpareMap[0].OctetOffset;
                       ...
                       FS_ERR                  *p_err)
{
    ...
    p_ctrlr_data->SpareBufSize = spare_seg_max_len;
