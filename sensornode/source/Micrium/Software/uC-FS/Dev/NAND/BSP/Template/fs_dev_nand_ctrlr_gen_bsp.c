...
*                                              TEMPLATE
*
* Filename      : fs_dev_nand_ctrlr_gen_bsp.c
* Version       : v4.07.00.00
* Programmer(s) : EJ
*                 FBJ
*********************************************************************************************************
...
*                                         INTERFACE STRUCTURE
*
* Note(s)     : (1) (a) The name given to this structure must be unique to avoid conflicts with other
*                       BSPs. 
*                   (b) When initializing the generic controller layer, you must declare this structure
*                       as a 'extern const FS_NAND_CTRLR_GENERIC_BSP_API' in the source file containing
...
* Return(s)   : none.
*
* Caller(s)   : Generic controller layer driver.
*
