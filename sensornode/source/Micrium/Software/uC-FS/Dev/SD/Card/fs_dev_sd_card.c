...
*
* Caller(s)   : FSDev_SD_Card_Refresh() (GO_IDLE_STATE).
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
*               DEF_FAIL, if command fails.
*
* Caller(s)   : FSDev_SD_Card_Refresh()       (CMD_SEND_RELATIVE_ADDR; CMD_SET_BLOCKLEN),
*               FSDev_SD_Card_MakeRdy()       (CMD_SEND_IF_COND; CMD_SEND_OP_COND),
*               FSDev_SD_Card_AppCmdRShort(),
*               FSDev_SD_Card_SendSCR()       (CMD_APP_CMD),
*               FSDev_SD_Card_SendSDStatus()  (CMD_APP_CMD),
*               FSDev_SD_Card_Stop()          (CMD_STOP_TRANSMISSION, CMD_SEND_STATUS),
*               FSDev_SD_Card_SetBusWidth()   (CMD_SWITCH_FUNC),
*               FSDev_SD_Card_Sel()           (CMD_SEL_DESEL_CARD),
*               FSDev_SD_Card_WaitWhileBusy() (CMD_SEND_STATUS).
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
*               DEF_FAIL, if command fails.
*
* Caller(s)   : FSDev_SD_Card_SendCID() (CMD_ALL_SEND_CID, CMD_SEND_CID),
*               FSDev_SD_Card_SendCSD() (CMD_SEND_CSD).
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
*               DEF_FAIL, if command fails.
*
* Caller(s)   : FSDev_SD_Card_MakeRdy()     (ACMD_SD_SEND_OP_COND),
*               FSDev_SD_Card_SetBusWidth() (ACMD_BUS_WIDTH).
*
...
*               DEF_FAIL otherwise.
*
* Caller(s)   : FSDev_SD_Card_IO_Ctrl(),
*               FSDev_SD_Card_Refresh().
*
...
*               DEF_FAIL otherwise.
*
* Caller(s)   : FSDev_SD_Card_SetBusWidth().
*
...
* Return(s)   : none.
*
* Caller(s)   : Various, via FS_DEV_SD_CARD_HANDLE_ERR_BSP().
*
* Note(s)     : none.
*********************************************************************************************************
*/
