...
* Return(s)   : Final token.
*
* Caller(s)   : FSDev_SD_SPI_RdDataMulti(),
*               FSDev_SD_SPI_WrData(),
*               FSDev_SD_SPI_WrDataMulti().
*
* Note(s)     : none.
