...
#endif
    FS_TRACE_INFO(("FSDev_NOR_Close(): Cannot close \"nor:%d\"\r\n", p_dev->UnitNbr));
...
* Return(s)   : none.
*
* Caller(s)   : FSDev_NOR_IO_Ctrl() (FS_DEV_IO_CTRL_LOW_FMT).
*
...
*               FSDev_NOR_IO_Ctrl() (FS_DEV_IO_CTRL_LOW_MOUNT),
*               FSDev_NOR_LowFmtHandler().
*
...
*
* Caller(s)   : FSDev_NOR_Open(),
*               FSDev_NOR_IO_Ctrl() (FS_DEV_IO_CTRL_LOW_UNMOUNT),
*               FSDev_NOR_LowFmtHandler(),
*               FSDev_NOR_LowMountHandler().
*
* Note(s)     : none.
...
* Return(s)   : none.
*
* Caller(s)   : FSDev_NOR_IO_Ctrl() (FS_DEV_IO_CTRL_LOW_COMPACT).
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
* Return(s)   : none.
*
* Caller(s)   : FSDev_NOR_IO_Ctrl() (FS_DEV_IO_CTRL_LOW_DEFRAG).
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
* Return(s)   : none.
*
* Caller(s)   : FSDev_NOR_LowMountHandler()
...
* Return(s)   : none.
*
* Caller(s)   : FSDev_NOR_WrSecLogical(),
...
* Return(s)   : none.
*
* Caller(s)   : FSDev_NOR_IO_Ctrl() (FS_DEV_IO_CTRL_REFRESH),
*               FSDev_NOR_WrSecLogical().
*
* Note(s)     : none.
*********************************************************************************************************
...
* Return(s)   : none.
*
* Caller(s)   : FSDev_NOR_InvalidateSec(),
*               FSDev_NOR_EraseBlkPrepare().
*
...
*               FS_DEV_NOR_SEC_NBR_INVALID, if NO block            needs to be erased.
*
* Caller(s)   : FSDev_NOR_FindEraseBlk().
*
...
* Return(s)   : none.
*
* Caller(s)   : FSDev_NOR_LowUnmountHandler().
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
* Return(s)   : none.
*
* Caller(s)   : FSDev_NOR_LowDefragHandler().
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
* Return(s)   : none.
*
* Caller(s)   : FSDev_NOR_EraseBlkPrepare().
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
*
* Caller(s)   : FSDev_NOR_WrSecLogicalHandler().
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
*
* Caller(s)   : FSDev_NOR_AllocDevData().
*
* Note(s)     : none.
*********************************************************************************************************
*/
