...
* Return(s)   : none.
*
* Caller(s)   : FSDev_IDE_Rd()      (RD_SEC / RD_DMA),
*               FSDev_IDE_Refresh() (IDENTIFY_DEVICE).
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
* Return(s)   : none.
*
* Caller(s)   : FSDev_IDE_Wr() (WR_SEC / WR_DMA).
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
* Return(s)   : none.
*
* Caller(s)   : FSDev_IDE_Refresh() (SET_TRANSFER_MODE).
*
* Note(s)     : none.
*********************************************************************************************************
*/
