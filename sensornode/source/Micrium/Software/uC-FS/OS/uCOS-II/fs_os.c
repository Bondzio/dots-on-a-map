...
* Caller(s)   : various.
*
*               This function is an INTERNAL file system suite function & SHOULD NOT be called by
*               application function(s).
*
...
* Return(s)   : none.
*
* Caller(s)   : FSFile_LockAcceptHandler().
*
*               This function is an INTERNAL file system suite function & SHOULD NOT be called by
*               application function(s).
*
...
* Return(s)   : none.
*
* Caller(s)   : FSFile_LockGetHandler().
*
*               This function is an INTERNAL file system suite function & SHOULD NOT be called by
*               application function(s).
*
...
*
* Caller(s)   : FSFile_LockSetHandler().
*
*               This function is an INTERNAL file system suite function & SHOULD NOT be called by
*               application function(s).
*
