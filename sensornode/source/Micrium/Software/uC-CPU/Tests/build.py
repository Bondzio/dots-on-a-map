...
class TestBuild(xmlrunner.TestCase):
    ...
    def test_build(self):
        SetDefine('cpu_cfg_orig.h', 'cpu_cfg.h', self.cpu_config)

        configuration = str(self.cpu_config)
...
def load_tests(loader, tests, pattern):
    ...
    with open(args.config, 'r') as f:
        for cpu_config in f:
            distinguisher = args.builder + ' ' + cpu_config.strip()
            ...
            test_case.cpu_config = cpu_config
