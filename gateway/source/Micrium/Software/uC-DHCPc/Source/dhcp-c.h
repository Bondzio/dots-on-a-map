...
typedef  enum dhcp_c_err {
    ...
    DHCPc_ERR_IF_CFG_STATE                           =   30,    /* IP cfg state err.                                    */
    DHCPc_ERR_IF_CFG                                 =   31,    /* IF cfg err.                                          */
    DHCPc_ERR_IF_NOT_CFG                             =   32,    /* IF NOT yet cfg'd with DHCP.                          */
    DHCPc_ERR_IF_INVALID                             =   33,    /* IF invalid or disabled.                              */
    DHCPc_ERR_IF_NOT_MANAGED                         =   34,    /* IF NOT managed by DHCP client.                       */
    DHCPc_ERR_IF_OPT_NONE                            =   35,    /* DHCP opt NOT present on IF.                          */

    DHCPc_ERR_IF_INFO_NONE_AVAIL                     =   40,    /* IF info  pool empty.                                 */
    DHCPc_ERR_IF_INFO_IF_USED                        =   41,    /* IF info  already already used for this IF.           */

    DHCPc_ERR_MSG_NONE_AVAIL                         =   50,    /* Msg      pool empty.                                 */
    DHCPc_ERR_MSG_Q                                  =   51,    /* Err posting to msg Q.                                */

    DHCPc_ERR_COMM_NONE_AVAIL                        =   60,    /* Comm obj pool empty.                                 */

    DHCPc_ERR_TMR_NONE_AVAIL                         =   80,    /* Tmr      pool empty.                                 */
    DHCPc_ERR_TMR_INVALID_MSG                        =   81,    /* Invalid tmr msg.                                     */
    DHCPc_ERR_TMR_CFG                                =   82,    /* Err cfg'ing tmr.                                     */

    DHCPc_ERR_ADDR_VALIDATE                          =   90,    /* Err validating addr.                                 */
    DHCPc_ERR_ADDR_USED                              =   91,    /* Addr in use.                                         */

    DHCPc_ERR_LOCAL_LINK                             =  100,    /* Err cfg'ing dyn link-local addr.                     */

    DHCPc_ERR_RX                                     =  110,    /* Rx err.                                              */
    DHCPc_ERR_RX_OVF                                 =  111,    /* Rx err data buffer ovf.                              */
    DHCPc_ERR_RX_NAK                                 =  112,    /* NAK msg rx'd.                                        */
    DHCPc_ERR_RX_MSG_TYPE                            =  113,    /* Rep msg type err.                                    */

    DHCPc_ERR_TX                                     =  120,    /* Tx err.                                              */

    DHCPc_ERR_IPv4_NOT_PRESENT                       =  130,    /* DHCPc requires NET_IP_CFG_IPv4_EN set to DEF_ENABLED */



    DHCPc_OS_ERR_NONE                                =  200,

    DHCPc_OS_ERR_INIT                                =  210,
    DHCPc_OS_ERR_CFG                                 =  211,

    DHCPc_OS_ERR_INIT_SIGNAL                         =  220,
    DHCPc_OS_ERR_INIT_SIGNAL_NAME                    =  221,
    DHCPc_OS_ERR_INIT_SIGNALD                        =  222,
    DHCPc_OS_ERR_INIT_LOCK                           =  223,
    DHCPc_OS_ERR_INIT_LOCK_NAME                      =  224,
    DHCPc_OS_ERR_INIT_Q                              =  225,
    DHCPc_OS_ERR_INIT_Q_NAME                         =  226,
    DHCPc_OS_ERR_INIT_TMR                            =  227,
    DHCPc_OS_ERR_INIT_TMR_SIGNAL                     =  228,
    DHCPc_OS_ERR_INIT_TMR_SIGNAL_NAME                =  229,

    DHCPc_OS_ERR_INIT_TASK                           =  240,
    DHCPc_OS_ERR_INIT_TASK_NAME                      =  241,
    DHCPc_OS_ERR_INIT_TMR_TASK                       =  242,
    DHCPc_OS_ERR_INIT_TMR_TASK_NAME                  =  243,
                                                        
    DHCPc_OS_ERR_LOCK                                =  250,
    DHCPc_OS_ERR_MSG_Q                               =  251,
    DHCPc_OS_ERR_TMR                                 =  252,
...
#define  DHCP_T1_LEASE_NUMERATOR                        1
#define  DHCP_T1_LEASE_DENOMINATOR                      2

#define  DHCP_T2_LEASE_NUMERATOR                        7
