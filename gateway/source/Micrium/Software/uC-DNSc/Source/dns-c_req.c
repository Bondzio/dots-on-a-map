                                          ...
                                          DNSc_ERR       *p_err)
{
   ...
   *p_cname = ASCII_CHAR_NULL;                                  /* Insert end of line char                              */
    ...
    class = NET_UTIL_HOST_TO_NET_16(DNSc_CLASS_IN);             /* Set query CLASS.                                     */
    Mem_Copy(p_query, &class, sizeof(class));
                                        ...
                                        DNSc_ERR       *p_err)
{
    ...
    for (ix = 0; ix < answer_nbr; ix++) {
        ...
        DNScReq_RxRespAddAddr(p_cfg, p_host, answer_type, p_data, p_err);
                                            ...
                                            DNSc_ERR       *p_err)
{
    ...
    DNScCache_HostAddrInsert(p_cfg, p_host, p_addr, p_err);
    if (*p_err != DNSc_ERR_NONE) {
         goto exit_release_addr;
    }
