...
*
* Note(s) : (1) By default FTP server tracing is disabled. FTP server tracing can be enabled by adding
...
*
*               (a) TRACE_LEVEL_OFF  will disable all output from the FTP server.
*
...
*               tracing messages. If FTPs_TRACE_LEVEL is configured to TRACE_LEVEL_OFF, there is no need
