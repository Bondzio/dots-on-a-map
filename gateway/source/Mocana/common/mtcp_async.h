...
#ifdef __WIN32_TCP__
extern MSTATUS TCP_ASYNC_CREATE_LIST(ubyte4 listMaxSize, TCP_SOCKET_LIST **ppRetSocketList);
extern MSTATUS TCP_ASYNC_ADD_TO_LIST(TCP_SOCKET_LIST *pSocketList, TCP_SOCKET socket, ubyte4 state, void *pCookie);
extern MSTATUS TCP_ASYNC_REM_FR_LIST(TCP_SOCKET_LIST *pSocketList, TCP_SOCKET socket, ubyte4 *pRetState, void **ppRetCookie);
extern MSTATUS TCP_ASYNC_SELECT(TCP_SOCKET_LIST *pSocketList, ubyte4 msTimeout);
extern MSTATUS TCP_ASYNC_FIRST_RD(TCP_SOCKET_LIST *pSocketList, ubyte4 *pRetTraverseCookie, tcpAsyncConnection **ppRetConnection);
extern MSTATUS TCP_ASYNC_NEXT_RD(TCP_SOCKET_LIST *pSocketList, ubyte4 *pRetTraverseCookie, tcpAsyncConnection **ppRetConnection);
extern MSTATUS TCP_ASYNC_FIRST_WR(TCP_SOCKET_LIST *pSocketList, ubyte4 *pRetTraverseCookie, tcpAsyncConnection **ppRetConnection);
extern MSTATUS TCP_ASYNC_NEXT_WR(TCP_SOCKET_LIST *pSocketList, ubyte4 *pRetTraverseCookie, tcpAsyncConnection **ppRetConnection);
extern MSTATUS TCP_ASYNC_FIRST_ERR(TCP_SOCKET_LIST *pSocketList, ubyte4 *pRetTraverseCookie, tcpAsyncConnection **ppRetConnection);
extern MSTATUS TCP_ASYNC_NEXT_ERR(TCP_SOCKET_LIST *pSocketList, ubyte4 *pRetTraverseCookie, tcpAsyncConnection **ppRetConnection);
#endif
