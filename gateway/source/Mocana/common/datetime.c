...
static sbyte4
DATETIME_calculateNumberSeconds( TimeDate* pDT1)
{
...
extern MSTATUS
DATETIME_convertToValidityString(TimeDate *pTime, sbyte *pOutputTime)
{
    ...
    } else
    {
        ...
        pOutputTime[0] = (ubyte)('0' + ((temp % 10000) / 10));
        pOutputTime[1] = (ubyte)('0' + ((temp % 1000) / 10 ));
        pOutputTime[3] = (ubyte)('0' + ((temp % 100) / 10));
